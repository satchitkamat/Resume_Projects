...
exports.startReactRouterView = startReactRouterView;
exports.computeViewName = computeViewName;
const browser_core_1 = require("@datadog/browser-core");
const reactPlugin_1 = require("../reactPlugin");
function startReactRouterView(routeMatches) {
    (0, reactPlugin_1.onRumInit)((configuration, rumPublicApi) => {
        if (!configuration.router) {
            browser_core_1.display.warn('`router: true` is missing from the react plugin configuration, the view will not be tracked.');
            return;
        }
 ...
 */
function substitutePathSplats(path, params, isLastMatchingRoute) {
    if (!path.includes('*') ||
...
//# sourceMappingURL=startReactRouterView.js.map