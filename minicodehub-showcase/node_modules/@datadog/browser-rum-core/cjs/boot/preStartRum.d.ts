...
import { startTelemetry } from '@datadog/browser-core';
...
export declare function createPreStartStrategy({ ignoreInitIfSyntheticsWillInjectRum, startDeflateWorker }: RumPublicApiOptions, trackingConsentState: TrackingConsentState, customVitalsState: CustomVitalsState, doStartRum: DoStartRum, startTelemetryImpl?: typeof startTelemetry): Strategy;
