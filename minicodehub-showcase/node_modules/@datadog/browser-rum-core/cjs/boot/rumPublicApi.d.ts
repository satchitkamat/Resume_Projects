import type { Context, DeflateWorker, DeflateEncoderStreamId, DeflateEncoder, PublicApi, ContextManager, TrackingConsent, User, Account, RumInternalContext, Telemetry, Encoder, startTelemetry } from '@datadog/browser-core';
...
export declare function makeRumPublicApi(startRumImpl: StartRum, recorderApi: RecorderApi, profilerApi: ProfilerApi, options?: RumPublicApiOptions, startTelemetryImpl?: typeof startTelemetry): RumPublicApi;
