...
function trackLargestContentfulPaint(configuration, firstHidden, eventTarget, callback) {
    ...
    const performanceLcpSubscription = (0, performanceObservable_1.createPerformanceObservable)(configuration, {
        ...
        if (lcpEntry) {
            ...
            const subParts = (0, browser_core_1.isExperimentalFeatureEnabled)(browser_core_1.ExperimentalFeature.LCP_SUBPARTS)
...
function computeLcpSubParts(resourceUrl, lcpValue) {
    const firstByte = (0, performanceUtils_1.sanitizeFirstByte)((0, performanceUtils_1.getNavigationEntry)());
    if (firstByte === undefined) {
        return undefined;
    }
    const lcpResourceEntry = resourceUrl ? (0, performanceUtils_1.findLcpResourceEntry)(resourceUrl, lcpValue) : undefined;
