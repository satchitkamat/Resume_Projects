...
const sessionInMemory_1 = require("./storeStrategies/sessionInMemory");
/**
...
function normalizePersistenceList(sessionPersistence, initConfiguration) {
    ...
    return initConfiguration.allowFallbackToLocalStorage
        ? [sessionConstants_1.SessionPersistence.COOKIE, sessionConstants_1.SessionPersistence.LOCAL_STORAGE]
        : [sessionConstants_1.SessionPersistence.COOKIE];
}
function selectStrategyForPersistence(persistence, initConfiguration) {
    switch (persistence) {
        ...
        case sessionConstants_1.SessionPersistence.MEMORY:
            return (0, sessionInMemory_1.selectMemorySessionStoreStrategy)();
        default:
            display_1.display.error(`Invalid session persistence '${String(persistence)}'`);
            return undefined;
    }
}
function getSessionStoreStrategy(sessionStoreStrategyType, configuration) {
    return sessionStoreStrategyType.type === sessionConstants_1.SessionPersistence.COOKIE
        ...
        : sessionStoreStrategyType.type === sessionConstants_1.SessionPersistence.LOCAL_STORAGE
            ? (0, sessionInLocalStorage_1.initLocalStorageStrategy)(configuration)
            : (0, sessionInMemory_1.initMemorySessionStoreStrategy)(configuration);
}
/**
